...
* **min_scoring_approve (int | None)**: Porcentaje mínimo para aprobar (1–100). Obtener del chat; null si no hay calificación mínima.

* **time_limit (bool)**: Indica si la evaluación tiene límite de tiempo. Obtener del chat.
...
```json
{
  ...
  "title": "<str>",
  "min_scoring_approve": "<int_o_null>",
  "time_limit": true,
